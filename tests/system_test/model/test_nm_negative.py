...
def test_CAN_NM_headerless_container_multiple_pdus_raises():
    ...
    contained_pdus = [
        ContainedPDURef(header_id=1, pdu_ref=NM_PDU_NAME, offset=0),
        ContainedPDURef(header_id=2, pdu_ref=NM_PDU_NAME, offset=8),
    ]
...
def test_Simple_Ethernet_ECU_Multicast_NM_container_too_small_raises():
    ...
    contained_pdus = [ContainedPDURef(header_id=1, pdu_ref=NM_PDU_NAME, offset=0)]
