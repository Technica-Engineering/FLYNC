...
class SInt8(BaseInt):
    ...
    ----------
    name : str
        Datatype name. Defaults to ``"SINT8"``.
...
class SInt16(BaseInt):
    ...
    ----------
    name : str
        Datatype name. Defaults to ``"SINT16"``.
...
class SInt32(BaseInt):
    ...
    ----------
    name : str
        Datatype name. Defaults to ``"SINT32"``.
...
class SInt64(BaseInt):
    ...
    ----------
    name : str
        Datatype name. Defaults to ``"SINT64"``.
