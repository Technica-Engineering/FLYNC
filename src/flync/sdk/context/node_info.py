...
Provides :class:`NodeInfo`, which captures type and path information for
nodes in the FLYNC model dependency graph.
"""
...
class NodeInfo:
    ...
    Attributes:
        ...
        python_type (Type): The Python type (usually a Pydantic model class)
